...
azure_vector_store_id_get_business_rules = os.getenv("azure-vector-store-id")
azure_vector_store_id_get_approver_email = os.getenv("azure-vector-store-id-approver")
